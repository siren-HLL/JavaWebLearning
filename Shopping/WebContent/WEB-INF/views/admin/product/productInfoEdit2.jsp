									...
									<form:form modelAttribute="product" id="form_productInfo" name="form_productInfo" method="POST">
										...
										<div class="row" style="padding:20px">
											...
											<div class="row">
											    <div class="form-group col-lg-6">
													<label>排序</label>
													<input name="sortOrder" class="form-control" type="text" placeholder="排序" value="${product.sortOrder}">
												</div>
											</div>
											<div class="form-group col-lg-6">
												<label>上传图片</label>
			...
			<div class="col-md-3">
				<div class="hpanel">
					<div class="panel-heading">商品选项 </div>
						...
						<button class="btn btn-success" onclick="createSku()" >生成SKU</button>
						<button class="btn btn-success" onclick="deleteSku()" >清除SKU</button>
